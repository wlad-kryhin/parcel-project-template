...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/modals.js":[function(require,module,exports) {
...
function hideModal() {
  var modalToClose = document.querySelector(".".concat(MODAL_ACTIVE_CLASS));
...
function hideModalOnMobileMenuElementsClick() {
  var MOBILE_MENU_ITEM_CLOSE_DELAY = 150;
  var menuElements = document.querySelectorAll('.mobile-menu-item');

  if (menuElements.length) {
    menuElements.forEach(function (container) {
      container.addEventListener('click', function () {
        return setTimeout(hideModal, MOBILE_MENU_ITEM_CLOSE_DELAY);
      });
    });
  }
}
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/modals.js"], null)
//# sourceMappingURL=/modals.c69c75c6.js.map